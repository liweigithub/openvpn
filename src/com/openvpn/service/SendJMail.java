...
public class SendJMail {
    public static boolean sendMail(String email, String emailMsg) {
        ...
        //设置邮件服务器的地址
        props.setProperty("mail.smtp.host", "smtp.163.com"); // 指定的smtp服务�?
        props.setProperty("mail.smtp.auth", "true");
        props.setProperty("mail.transport.protocol", "smtp");//设置发�?邮件使用的协�?
        //创建Session对象,session对象表示整个邮件的环境信�?
		...
		public static void main(String[] args) {
			sendMail("1099532501@qq.com", "sadas");
		}
}
